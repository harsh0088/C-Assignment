        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Matches>(entity =>
            {
                ...
                entity.HasOne(d => d.TeamANavigation)
                    ...
                    .HasConstraintName("FK__Matches__Team_A__73BA3083");

                entity.HasOne(d => d.TeamBNavigation)
                    .WithMany(p => p.MatchesTeamBNavigation)
                    .HasForeignKey(d => d.TeamB)
                    .HasConstraintName("FK__Matches__Team_B__74AE54BC");
            });
            ...
            modelBuilder.Entity<Player>(entity =>
            {
                ...
                entity.HasOne(d => d.Country)
                    ...
                    .HasConstraintName("FK__Player__country___66603565");
            });
            ...
            modelBuilder.Entity<Stadium>(entity =>
            {
                ...
                entity.HasOne(d => d.StadiumNavigation)
                    ...
                    .HasConstraintName("FK__Stadium__stadium__778AC167");
            });
        }
    }
}
